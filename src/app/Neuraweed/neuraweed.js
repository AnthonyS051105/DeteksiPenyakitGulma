...
export default function Neuraweed() {
  return (
        ...
        <div className="text-center">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-xl text-[#139186] leading-relaxed mb-6">
              Sistem deteksi gulma berbasis AI yang membantu petani mengidentifikasi dan mengelola gulma pada lahan pertanian secara efektif.
            </p>
            <p className="text-lg text-[#0f7d73] leading-relaxed">
              NeuraWeed menggunakan teknologi deep learning untuk mendeteksi berbagai jenis gulma dan memberikan strategi pengendalian yang optimal.
            </p>
          </div>
          <div className="mt-12">
